...
export function Footer() {
  return (
    <section className="relative overflow-hidden bg-white border-secondary border-t-2 py-8">
      <div className="container max-w-7xl relative z-10 mx-auto px-4 lg:px-8">
