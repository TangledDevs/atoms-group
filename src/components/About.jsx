        ...
        <div className="mx-auto max-w-7xl lg:grid lg:grid-cols-12 lg:gap-x-8 lg:px-8">
          ...
          <div className="flex flex-col justify-center px-4 py-12 md:py-12 lg:col-span-7 lg:gap-x-6 lg:px-6 lg:py-12 xl:col-span-6">
            ...
            <p className="mt-8 text-lg text-white">
              Atoms Group is a startup committed to providing exceptional
              services in the fields of digital marketing, education, and
              hospitality. Here is what sets us apart:
            </p>
            ...
            <p className="mt-8 text-lg text-white">
              Join us on this journey of growth and success. Together, we can
              make a difference.
            </p>
          </div>
        </div>
